...
import healthcare.config.StorageProperties;
import healthcare.exception.StorageException;
    ...
    public void store(MultipartFile file, String storeFileName){
        try{
            ...
            if (!destinationFile.getParent().equals(this.rootLocation.toAbsolutePath())){
                throw new StorageException("cannot sotre file outside curent directory");
            }
